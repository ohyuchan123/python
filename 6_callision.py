...
#배경 이미지 불러오기
background=pygame.image.load("C:\\Users\\user\\Desktop\\Python\\background.png")

#캐릭터(스프라이트)불러오기
character=pygame.image.load("C:\\Users\\user\\Desktop\\Python\\character.png") 
...
#적 캐릭터
enemy=pygame.image.load("C:\\Users\\user\\Desktop\\Python\\enemy.png") 
...
while running:
    ...
    for event in pygame.event.get(): #어떤 이벤트가 발생하였는가
        if event.type == pygame.QUIT: #창이 닫히는 이벤트가 발생하였는 가
